            ...
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">
                  Nice to meet you, <span style={{color:'#c4041d'}}>N</span>Uer!</p>
                <form class="mx-1 mx-md-4">
                  ...
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <button type="button" class="btn btn-primary btn-lg" style={{backgroundColor:'#c4041d', borderColor: '#c4041d'}}>Sign Up</button>
                  </div>
                  <div class="text-center">
                    <p>
                      Already has an account? <a href="./signin" style={{color:'#c4041d'}}>Sign in</a>
                    </p>
                  </div>
                </form>
              </div>
